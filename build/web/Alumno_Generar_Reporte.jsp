        ...
        <form method="post" class="formGenerarReporte" action="Control_Generar_Reporte.jsp" >
            ...
            <table border="0">
                <tr>
                    ...
                    <td  WIDTH="100" HEIGHT="20" >   <input required="" id="date" type="date" name="FechaFin"> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td  WIDTH="100" HEIGHT="20" >   <input required="" id="date" type="date" name="FechaInicio"> </td>
                ...
                <tr>
                    ...
                    <td  WIDTH="100" HEIGHT="20" >  <input  type="number" value="0" name="Horas_Restantes"> </td>
